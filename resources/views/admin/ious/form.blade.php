...
</div><div class="form-group {{ $errors->has('currrency') ? 'has-error' : ''}}">
    {!! Form::label('currrency', 'Currrency', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::select('currrency', json_decode('{"EUR":"Euros","BTC":"Bitcoins"}', true), null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
        {!! $errors->first('currrency', '<p class="help-block">:message</p>') !!}
    </div>
